...
<body>
	<div id="container">
		...
		<div id="content">
			<div id="board">
				<form class="board-form" method="post" action="${pageContext.servletContext.contextPath }/board/comment/reply">
					...
					<div class="bottom">
						<a href="${pageContext.servletContext.contextPath }/board/view/=${vo.board_no}">취소</a>
